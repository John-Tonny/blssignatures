...
This library is a JavaScript port of the [Chia Network's BLS lib](https://github.com/John-Tonny/blssignatures). We also have typings, so you can use it with TypeScript too!

### Usage

```bash
npm i https://github.com/John-Tonny/blssignatures --save # or yarn add https://github.com/John-Tonny/blssignatures
```

### Creating keys and signatures
```javascript
  var loadBls = require("blssignatures");
